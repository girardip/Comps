...
```{r Filters out incomplete individual obs}
# This filters lots of stuff, because I will be taking out all the first observations, and many people only have 1-2 obs
reducedPME = reducedPME[!is.na(reducedPME$lagRealWage),]

# Also takes out NAN/Inf values for pct change in income
reducedPME = reducedPME[!is.infinite(reducedPME$pctChangeWage),]
```
