...
rotPMEstates = rotPME%>% filter(cod=="V035", rotulo%in%levels(reduced_pme$MetropolitanArea))
...
left_join(reduced_pme, inflation, by=c("MetropolitanArea" = "Region", "Month" = "Month"))
```
