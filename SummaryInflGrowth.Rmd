...
plot4=ggplot(inflation, aes(x=Month, y=Inflation)) + 
  geom_line(aes(col=as.factor(paste0(Year, Region)))) +
...
ggsave("Plots/plot4_macro.jpeg", plot4, device = "jpeg", width = 6, height=6, units="in")
